...
namespace dqm4hep
{
  ...
  DQM_PLUGIN_DECL( AHCAL_96Layers , "AHCAL_96Layers" )

  //-------------------------------------------------------------------------------------------------

  AHCAL_96Layers::AHCAL_96Layers() :
  DQMAnalysisModule()
  {
  ...
  StatusCode AHCAL_96Layers::readSettings(const TiXmlHandle xmlHandle)
  {
   ...
   // ########################################################################################################################################
    ...
    RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, AHCAL_96Layers::buildGeometryMap(xmlGeometryFileHandle));
  ...
  StatusCode AHCAL_96Layers::initModule()  {
  ...
  StatusCode AHCAL_96Layers::endModule()  {
  ...
  StatusCode AHCAL_96Layers::processEvent(DQMEvent *pEvent)  {
    //int EventCntIndex = 1;
    int BxIDIndex = 1;
    int EvtNrIndex = 2;
    int ChipIDIndex = 3;
  ...
  StatusCode AHCAL_96Layers::startOfCycle()  {
  ...
  StatusCode AHCAL_96Layers::endOfCycle()
  {
  ...
  StatusCode AHCAL_96Layers::startOfRun(DQMRun *pRun)
  {
  ...
  StatusCode AHCAL_96Layers::endOfRun(DQMRun *pRun)
  {
  ...
  StatusCode AHCAL_96Layers::buildGeometryMap(const TiXmlHandle xmlHandle)
  {
  ...
  int AHCAL_96Layers::electronicsToIJK(int Chip, int Channel)
  {
  ...
  int AHCAL_96Layers::IJKToElectronics(int I, int J, int K)
  {
    std::map<int, int>::iterator itMap;
