...
#ifndef AHCAL_96Layers_H
#define AHCAL_96Layers_H

#define C_MAX_LAYERS 96
...
namespace dqm4hep {
  ...
  /** AHCAL_96Layers class
   */ 
  class AHCAL_96Layers : public DQMAnalysisModule {
  public:
    AHCAL_96Layers();
    ~AHCAL_96Layers();
