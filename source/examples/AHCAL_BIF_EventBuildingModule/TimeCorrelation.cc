...
namespace dqm4hep
{
  ...
  StatusCode TimeCorrelation::readSettings(const TiXmlHandle xmlHandle)
  {
    ...
    //channel 1
    m_pTDCvsTime_1 = NULL;
    m_pBXIDvsTime_1 = NULL;
    m_pBXIDvsBXIDbif_1 = NULL;

    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDCvsTime_1", m_pTDCvsTime_1));
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "BXIDvsTime_1", m_pBXIDvsTime_1));
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "BXIDvsBXIDbif_1", m_pBXIDvsBXIDbif_1));

    //channel 2
    m_pTDCvsTime_2 = NULL;
    m_pBXIDvsTime_2 = NULL;
    m_pBXIDvsBXIDbif_2 = NULL;

    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDCvsTime_2", m_pTDCvsTime_2));
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "BXIDvsTime_2", m_pBXIDvsTime_2));
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "BXIDvsBXIDbif_2", m_pBXIDvsBXIDbif_2));


    //channel 3
    m_pTDCvsTime_3 = NULL;
    m_pBXIDvsTime_3 = NULL;
    m_pBXIDvsBXIDbif_3 = NULL;

    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDCvsTime_3", m_pTDCvsTime_3));
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "BXIDvsTime_3", m_pBXIDvsTime_3));
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "BXIDvsBXIDbif_3", m_pBXIDvsBXIDbif_3));
