...
namespace dqm4hep
{
  ...
  StatusCode HitMapTemperature::readSettings(const TiXmlHandle xmlHandle)
  {
    ...
    RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, AHCALRawModuleGlobal::buildGeometryMap(xmlGeometryFileHandle));
  ...
  StatusCode AHCALRawModuleGlobal::buildGeometryMap(const TiXmlHandle xmlHandle)
  {
  ...
  int AHCALRawModuleGlobal::electronicsToIJK(int Chip, int Channel)
  {
  ...
  int AHCALRawModuleGlobal::IJKToElectronics(int I, int J, int K)
  {
    std::map<int, int>::iterator itMap;
