...
namespace dqm4hep
{
  ...
  StatusCode AHCALRawModuleChannel::readSettings(const TiXmlHandle xmlHandle)
  {
    ...
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDC_ROC_ch1",m_pTDC_ROC_1)); //ROC
    ...
    m_pADC_ROC_1->get<TGraph>()->SetTitle(TString::Format("ADC_ROC_ChipID%d_chn%d",m_ChipID1,m_ChannelNum1)); //ROC
    m_pTDC_ROC_1->get<TGraph>()->SetTitle(TString::Format("TDC_ROC_ChipID%d_chn%d",m_ChipID1,m_ChannelNum1)); //ROC
    ...
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDC_ROC_ch2",m_pTDC_ROC_2)); //ROC
    ...
    m_pADC_ROC_2->get<TGraph>()->SetTitle(TString::Format("ADC_ROC_ChipID%d_chn%d",m_ChipID2,m_ChannelNum2)); //ROC
    m_pTDC_ROC_2->get<TGraph>()->SetTitle(TString::Format("TDC_ROC_ChipID%d_chn%d",m_ChipID2,m_ChannelNum2)); //ROC
    ...
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDC_ROC_ch3",m_pTDC_ROC_3)); //ROC
    ...
    m_pADC_ROC_3->get<TGraph>()->SetTitle(TString::Format("ADC_ROC_ChipID%d_chn%d",m_ChipID3,m_ChannelNum3)); //ROC
    m_pTDC_ROC_3->get<TGraph>()->SetTitle(TString::Format("TDC_ROC_ChipID%d_chn%d",m_ChipID3,m_ChannelNum3)); //ROC
    ...
    RETURN_RESULT_IF(STATUS_CODE_SUCCESS, !=, DQMXmlHelper::bookMonitorElement(this, xmlHandle, "TDC_ROC_ch4",m_pTDC_ROC_4)); //ROC
    ...
    m_pADC_ROC_4->get<TGraph>()->SetTitle(TString::Format("ADC_ROC_ChipID%d_chn%d",m_ChipID4,m_ChannelNum4)); //ROC
    m_pTDC_ROC_4->get<TGraph>()->SetTitle(TString::Format("ADC_ROC_ChipID%d_chn%d",m_ChipID4,m_ChannelNum4)); //ROC
		...
		for(int e=0 ; e<nElements ; e++)
		  {
			...
			if(pAHCALRaw->getIntVal(ChipIDIndex) == m_ChipID1 && f == m_ChannelNum1 ) Ch_1=true;
			if(pAHCALRaw->getIntVal(ChipIDIndex) == m_ChipID2 && f == m_ChannelNum2 ) Ch_2=true;
			if(pAHCALRaw->getIntVal(ChipIDIndex) == m_ChipID3 && f == m_ChannelNum3 ) Ch_3=true;
			if(pAHCALRaw->getIntVal(ChipIDIndex) == m_ChipID4 && f == m_ChannelNum4 ) Ch_4=true;

			if( Ch_1==true || Ch_2==true || Ch_3==true || Ch_4==true ){ 
			  ...
			  if(Ch_1) {
			    ...
			    Int_t pointID = m_pADC_ROC_1->get<TGraph>()->GetN();
			    m_pADC_ROC_1->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , adc[f] );
			    m_pTDC_ROC_1->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , tdc[f] );
			  ...
			  if(Ch_2) {
			    ...
			    Int_t pointID = m_pADC_ROC_2->get<TGraph>()->GetN();
			    m_pADC_ROC_2->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , adc[f] );
			    m_pTDC_ROC_2->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , tdc[f] );
			  ...
			  if(Ch_3) {
			    ...
			    Int_t pointID = m_pADC_ROC_3->get<TGraph>()->GetN();
			    m_pADC_ROC_3->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , adc[f] );
			    m_pTDC_ROC_3->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , tdc[f] );
			  ...
			  if(Ch_4) {
			    ...
			    Int_t pointID = m_pADC_ROC_4->get<TGraph>()->GetN();
			    m_pADC_ROC_4->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , adc[f] );
			    m_pTDC_ROC_4->get<TGraph>()->SetPoint(pointID, pAHCALRaw->getIntVal(CycleNrIndex) , tdc[f] );
