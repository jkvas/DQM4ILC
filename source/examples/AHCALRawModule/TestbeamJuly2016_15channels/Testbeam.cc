...
namespace dqm4hep
{
  ...
  StatusCode Testbeam::readSettings(const TiXmlHandle xmlHandle)
  {
    ...
    // m_ChannelNr_c = 0;
    // m_ChannelNr_d = 0;
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "ChannelNr_a", m_ChannelNr_a));
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "ChannelNr_b", m_ChannelNr_b));
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "ChannelNr_c", m_ChannelNr_c));
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "ChannelNr_d", m_ChannelNr_d));

    // m_asicNr_a = 0;
    // m_asicNr_b = 0;
    // m_asicNr_c = 0;
    // m_asicNr_d = 0;
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "asicNr_a", m_asicNr_a));
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "asicNr_b", m_asicNr_b));
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "asicNr_c", m_asicNr_c));
    // RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=, DQMXmlHelper::readParameterValue(xmlHandle, "asicNr_d", m_asicNr_d));
  ...
  StatusCode Testbeam::startOfRun(DQMRun *pRun)
  {
    ...
    std::cout<<m_ChannelNr_a<<std::endl;
  ...
  StatusCode Testbeam::endOfRun(DQMRun *pRun)
  {
    ...
    std::cout<< " Summary, end of run ADC" <<std::endl;
    std::cout<< " ##################################################################### " <<std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic1"<<std::endl;
    std::cout <<m_pADC_01_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_02_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_03_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_04_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_05_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_06_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_07_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_08_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_09_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_10_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_11_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_12_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_13_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_14_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_15_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic2"<<std::endl;
    std::cout <<m_pADC_01_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_02_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_03_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_04_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_05_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_06_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_07_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_08_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_09_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_10_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_11_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_12_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_13_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_14_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_15_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic3"<<std::endl;
    std::cout <<m_pADC_01_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_02_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_03_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_04_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_05_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_06_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_07_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_08_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_09_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_10_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_11_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_12_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_13_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_14_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_15_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic4"<<std::endl;
    std::cout <<m_pADC_01_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_02_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_03_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_04_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_05_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_06_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_07_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_08_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_09_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_10_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_11_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_12_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_13_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_14_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pADC_15_d->get<TH1I>()->GetMean()<< std::endl;

    std::cout<< " Summary, end of run TDC" <<std::endl;
    std::cout<< " ##################################################################### " <<std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic1"<<std::endl;
    std::cout <<m_pTDC_01_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_02_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_03_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_04_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_05_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_06_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_07_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_08_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_09_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_10_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_11_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_12_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_13_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_14_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_15_a->get<TH1I>()->GetMean()<< std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic2"<<std::endl;
    std::cout <<m_pTDC_01_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_02_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_03_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_04_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_05_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_06_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_07_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_08_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_09_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_10_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_11_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_12_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_13_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_14_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_15_b->get<TH1I>()->GetMean()<< std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic3"<<std::endl;
    std::cout <<m_pTDC_01_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_02_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_03_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_04_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_05_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_06_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_07_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_08_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_09_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_10_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_11_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_12_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_13_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_14_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_15_c->get<TH1I>()->GetMean()<< std::endl;
    std::cout<< " "<<std::endl;
    std::cout<< "asic4"<<std::endl;
    std::cout <<m_pTDC_01_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_02_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_03_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_04_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_05_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_06_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_07_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_08_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_09_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_10_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_11_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_12_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_13_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_14_d->get<TH1I>()->GetMean()<< std::endl;
    std::cout <<m_pTDC_15_d->get<TH1I>()->GetMean()<< std::endl;
